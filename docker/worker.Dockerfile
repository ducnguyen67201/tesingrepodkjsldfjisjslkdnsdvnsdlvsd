...
# Copy production node_modules (root + app)
...
# pnpm creates symlinks like node_modules/@ducsigr/shared -> ../../packages/shared
# These break in Docker, so we copy the actual built packages
