-- CreateExtension (if using pgvector for embeddings)
...
-- CreateTable (Many-to-many for GitPullRequest <-> GitCommit)
...
-- CreateIndex
CREATE UNIQUE INDEX "_GitCommitToGitPullRequest_AB_unique" ON "_GitCommitToGitPullRequest"("A", "B");
